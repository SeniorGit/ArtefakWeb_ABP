                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-12 col-xs-12">
                                <div class="widget footer-about-us">
                                    <img src="/uploads/{{$about->logo}}" alt="" class="logo">
                                    <p class="mb-30">OHM Cloud sebuah toko yang menyediakan Vaper premium dengan kelas atas.</p>
                            ...
                            <div class="col-md-2 col-md-offset-1 col-sm-6 col-xs-12">
                                <div class="widget footer-links">
                                    ...
                                    <ul class="list-no-dividers">
                                        <li><a href="https://maps.app.goo.gl/vmFbRe9Vz6ETkStJA" target="_blank">Toko Kami</a></li>
                            ...
                            <div class="col-md-2 col-sm-6 col-xs-12">
                                <div class="widget footer-links">
                                    ...
                                    <ul class="list-no-dividers">
                                        <li><a href="/login_member">Masuk Akun</a></li>
                                        <li><a href="/register_member">Buat Akun</a></li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-sm-6 copyright sm-text-center">
                                <span>
                                    &copy; 2024 OHM Cloud, Made with 💖 by Teman Akmal Telkom University
                                </span>
                            </div>
                        </div>
                    </div>
