            ...
            <div class="w-full lg:w-1/2 bg-white p-10 px-5 md:px-20">
                ...
                <form action="/register_member " class="mt-10" method="POST">
                    ...
                    <div class="my-3">
                        ...
                        <input required type="text" placeholder="Bandung" name="kabupaten" id="kabupaten"
                            class="block border-2 rounded-full mt-2 py-2 px-5 w-full">
                    </div>
                    <div class="my-3">
                        <label class="font-semibold" for="kecamatan">Kecamatan</label>
                        <input required type="text" placeholder="Dayeuhkolot" name="kecamatan" id="kecamatan"
                            class="block border-2 rounded-full mt-2 py-2 px-5 w-full">
                    </div>
                    <div class="my-3">
                        <label class="font-semibold" for="detail_alamat">Detail Alamat</label>
                        <input required type="text" placeholder="Jl. Telekomunikasi. 1, Terusan Buahbatu - Bojongsoang, Telkom University, Sukapura" name="detail_alamat" id="detail_alamat"
                            class="block border-2 rounded-full mt-2 py-2 px-5 w-full">
                    </div>
                    <div class="my-3">
