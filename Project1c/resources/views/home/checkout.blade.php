            ...
            <div class="ecommerce col-xs-12">
                ...
                <form name="checkout" class="checkout ecommerce-checkout row" method="POST" action="/payments">
                    ...
                    <div class="col-md-8" id="customer_details">
                        <div>
                            <h2 class="heading uppercase bottom-line full-grey mb-30">alamat penagihan</h2>
                            ...
                            <div id="payment" class="ecommerce-checkout-payment">
                                ...
                                <li class="payment_method_bacs">
                                    ...
                                    <div class="payment_box payment_method_bacs">
                                        <p>Setelah melakukan pembayaran transfer bank, pastikan untuk menyimpan bukti pembayaran agar kami dapat membantu ada bila terjadi masalah.</p>
                                        <p>Atas Nama : {{$about->atas_nama}}</p>
                                        <p>No Rekening : {{$about->no_rekening}}</p>
                                    </div>
                                </li>

                                <li class="payment_method_new">
                                    <input id="payment_method_new" type="radio" class="input-radio"
                                        name="payment_method" value="new">
                                    <label for="payment_method_new">QRIS</label>
                                    <div class="payment_box payment_method_new" style="display: none;">
                                        <p>Kami juga menerima pembayaran QRIS, yang di mana QRIS mata uang yang bisa di akses di mana saja (termasuk e-wallet dan banking app). Sama seperti transfer bank, pastikan setelah membayar untuk menyimpan bukti pembayaran agar kami dapat membantu ada bila terjadi masalah.</p>
                                        <img src="/front/img/QR_code.png" alt="">
                                    </div>
                                </li>
                                </ul>
                                <div class="form-row place-order">
                                    <input type="submit" name="ecommerce_checkout_place_order"
                                        class="btn btn-lg btn-dark" id="place_order" value="Pesan">
                                </div>
                            </div>
                        </div>
